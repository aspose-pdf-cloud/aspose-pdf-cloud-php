...
$responseAnnotations = $pdfApi->getDocumentRedactionAnnotations($name, null, $tempFolder);
$annotationId = $responseAnnotations->getAnnotations()->getList()[0]->getId();
$response = $pdfApi->putRedactionAnnotation($name, $annotationId, $annotation, null, $tempFolder);
print $response
?>