...
$responseAnnotations = $pdfApi->getDocumentStampAnnotations($name, null, $tempFolder);
$annotationId = $responseAnnotations->getAnnotations()->getList()[0]->getId();


$response = $pdfApi->putStampAnnotation($name, $annotationId, $annotation, null, $tempFolder);
