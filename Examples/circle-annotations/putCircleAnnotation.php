...
$responseAnnotations = $pdfApi->getDocumentCircleAnnotations($name, null, $tempFolder);
$annotationId = $responseAnnotations->getAnnotations()->getList()[0]->getId();
$response = $pdfApi->putCircleAnnotation($name, $annotationId, $annotation, null, $tempFolder);
echo $response
