...
$response = $pdfApi->postPageSoundAnnotations($name, $pageNumber, [$annotation], null, $tempFolder);
...
$response = $pdfApi->putSoundAnnotation($name, $annotationId, $annotation, null, $tempFolder);
