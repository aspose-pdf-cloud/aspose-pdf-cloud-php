...
*Inherited from [\Aspose\PDF\Model\PopupAnnotation](PopupAnnotation.md)*
## Properties
Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**parent** | [**\Aspose\PDF\Model\AnnotationInfo**](AnnotationInfo.md) | Parent of annotation. | [optional]
**color** | [**\Aspose\PDF\Model\Color**](Color.md) | Color of the annotation.<br />*Inherited from [\Aspose\PDF\Model\PopupAnnotation](PopupAnnotation.md)* | [optional]
**open** | **bool** | Gets or sets a flag specifying whether the pop-up annotation should initially be displayed open.<br />*Inherited from [\Aspose\PDF\Model\PopupAnnotation](PopupAnnotation.md)* | [optional]
...
[[Back to Model list]](../README.md#documentation-for-models) [[Back to API list]](../README.md#documentation-for-api-endpoints) [[Back to README]](../README.md) [[View Source]](../src/Aspose/PDF/Model/PopupAnnotationWithParent.php)
