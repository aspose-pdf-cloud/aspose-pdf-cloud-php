...
------------ | ------------- | ------------- | -------------
**interior_color** | [**\Aspose\PDF\Model\Color**](Color.md) | Get the annotation InteriorColor. | [optional]
**frame** | [**\Aspose\PDF\Model\RectanglePdf**](RectanglePdf.md) | Get or set the annotation Rectangle of frame. | [optional]
...
[[Back to Model list]](../README.md#documentation-for-models) [[Back to API list]](../README.md#documentation-for-api-endpoints) [[Back to README]](../README.md) [[View Source]](../src/Aspose/PDF/Model/CommonFigureAnnotation.php)
